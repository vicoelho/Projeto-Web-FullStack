...
export default class Discord extends React.Component {
    ...
    logar(){
        ...
        fetch('http://localhost:8080/logar', options)
            .then(Res => Res.json())
                .then(Res => {
                    if (Res.Logado) {
                        localStorage.setItem('Token', Res.User);
                        localStorage.setItem('Postagens', Res.Postagens);
        ...
        return(
            <div>
                <div class="Tela">
                    <div class="Cima">
                        <div class="CimaItens">
                            <svg width="124" height="34" viewBox="0 0 124 34" class="CimaLogo">
                                <g fill="currentColor">
                            ...
                            <div class="CimaMeio">
                                <a href="https://discord.com/download" class="CimaMeioItem"><b>Baixar</b></a>
                                <a href="https://discord.com/nitro" class="CimaMeioItem"><b>Nitro</b></a>
                                <a href="https://discord.com/nitro" class="CimaMeioItem"><b>Descubra</b></a>
                                <a href="https://discord.com/safety" class="CimaMeioItem"><b>Segurança</b></a>
                                <a href="https://support.discord.com/hc/pt-br" class="CimaMeioItem"><b>Suporte</b></a>
                                <a href="https://discord.com/blog" class="CimaMeioItem"><b>Blog</b></a>
                                <a href="https://discord.com/careers" class="CimaMeioItem"><b>Carreiras</b></a>
                            </div>

                            <a href="https://discord.com/login" class="CimaAbrir">Entrar</a>

                            <button class="Hamburger" aria-hidden="false">
                                <svg width="40" height="40" viewBox="0 0 40 40">
                                    <path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M33.3327 10H6.66602V15H33.3327V10ZM6.66602 18.3317H33.3327V23.3317H6.66602V18.3317ZM6.66602 26.665H33.3327V31.665H6.66602V26.665Z">
                                    </path>
                                </svg>
                    ...
                    <div class="Meio">
                        <div class="MeioItens">
                            <div class="MeioTitulo">
                                <span class="MeioWeb">
                                    <b>IMAGINE UM<br />LUGAR...</b>
                                </span>
                                <span class="MeioMob">
                                    <b>IMAGINE UM LUGAR...</b>
                                </span>
                            </div>
                            
                            <div class="MeioDescricao">
                                <span class="MeioWeb">
                                    ...onde você possa pertencer a um clube escolar, um grupo de gamers, ou uma comunidade<br />
                                    artística mundial. Onde você e alguns amigos possam passar um tempo juntos. Um lugar que<br />
                                    torna fácil conversar todos os dias e socializar com mais frequência.
                                </span>
                                <span class="MeioMob">
                                    ...onde você possa pertencer a um clube escolar, um<br />
                                    grupo de gamers, ou uma comunidade artística<br />
                                    mundial. Onde você e alguns amigos possam passar<br />
                                    um tempo juntos. Um lugar que torna fácil conversar<br />
                                    todos os dias e socializar com mais frequência.
                                </span>
                            </div>
                            
                            <div class="MeioBotoes">
                                <a href="https://discord.com" class="MeioBotaoDownload">
                                ...
                                <a href="https://discord.com" class="MeioBotaoAbrir">Abra o Discord no seu navegador</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="apiLogin">
                    <div class="SeparaLogin">
                        <p class="LoginParagrafo">
                            Login:
                        </p>
                        <div>
                            <label class="login">Usuario:</label>
                            <input type="text" id="LoginUser" value={this.state.User} onChange={this.ChangeUser.bind(this)}/><br /><br />
                        </div>
                        <div>
                            <label class="loginSenha">Senha:</label>
                            <input type="password" id="LoginSenha" value={this.state.Password} onChange={this.ChangePassword.bind(this)}/><br /><br />
                        </div>
                        <div class="LoginBotoes">
                            <button id="LoginEntrar" onClick={this.logar.bind(this)}>Entrar</button>
                            <a id="LoginCadastrar" href="/cadastro">Registrar-se</a>
                        </div>
                        <label class="LoginError">{this.state.msg}</label>
                    </div>
                    <img src="./Imgs/LOGIN_img"  class="ImgLogin" />
                </div>
            </div>
        );
    }
